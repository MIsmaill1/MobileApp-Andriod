...
public class UserSharedAccountPropetyImagesAdapter extends RecyclerView.Adapter<UserSharedAccountPropetyImagesAdapter.viewHolder> {
    Context context;
    ...
    public UserSharedAccountPropetyImagesAdapter(Context context, ArrayList<PropertyDetailsimageModel> propertyImagesList, int newsannoce){
    ...
    @NonNull
    @Override
    public UserSharedAccountPropetyImagesAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from( context ).inflate( R.layout.sub_feature_image_layout,parent,false );
        return new UserSharedAccountPropetyImagesAdapter.viewHolder( v );
    }

    @Override
    public void onBindViewHolder(@NonNull UserSharedAccountPropetyImagesAdapter.viewHolder holder, @SuppressLint("RecyclerView") int position) {
