...
public class Possession extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_possession );
    ...
    private void id(){
        ...
        back = findViewById( R.id.back_to_Allotment);
        user = findViewById( R.id.user_icon_Allotment);
        notification = findViewById( R.id.notification_Allotment);
