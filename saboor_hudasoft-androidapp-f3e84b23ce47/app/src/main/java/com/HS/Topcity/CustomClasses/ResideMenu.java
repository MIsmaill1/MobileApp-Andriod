...
View v = inflater.inflate( R.layout.activity_menu, this);

        LinearLayout ll = v.findViewById( R.id.develop );

        ll.setOnClickListener( new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, Development.class );
        ...
        if (customLeftMenuId >= 0) {
            ...
            scrollViewLeftMenu = inflater.inflate(
                    R.layout.activity_menu, this, false);
    ...
    public void setShadowVisible(boolean isVisible) {
        if (isVisible)
            imageViewShadow.setBackgroundResource(R.color.white);
        else
