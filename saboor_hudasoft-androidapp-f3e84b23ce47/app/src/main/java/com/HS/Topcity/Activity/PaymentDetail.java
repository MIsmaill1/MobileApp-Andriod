...
public class PaymentDetail extends AppCompatActivity {
     ...
     //   getWindow().setFlags( WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN );
        ...
        online_payment.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent a = new Intent(getApplicationContext(),PaymentDetailReceipt.class);
                startActivity( a );
            }
        } );
    ...
    private void id(){
        back = findViewById( R.id.back_to_paymentDetail);
        user = findViewById( R.id.user_icon_paymentDetail);
        notification = findViewById( R.id.notification_paymentDetail );
        online_payment = findViewById( R.id.online_payment_receipt );
