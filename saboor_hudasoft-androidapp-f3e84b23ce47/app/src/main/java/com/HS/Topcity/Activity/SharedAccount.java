...
public class SharedAccount extends AppCompatActivity {
    ...
    private void ids(){
        notification = findViewById( R.id.notification_created_Account );
        user = findViewById( R.id.user_icon_CreateAccount );
        back = findViewById( R.id.back_to_create_account );
        add_user_btn = findViewById( R.id.AddNewUser_Btn );
    }
