 ...
 * Use the {@link Complains#newInstance} factory method to
...
View v = inflater.inflate( R.layout.fragment_complains, container, false );;
        back.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container, new ServicesDesk()).commit();
