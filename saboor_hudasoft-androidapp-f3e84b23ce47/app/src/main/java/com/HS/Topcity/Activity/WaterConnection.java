...
public class WaterConnection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_water_connection );
  ...
  //      getWindow().setFlags( WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN );
    ...
    private void id(){
        ...
        back = findViewById( R.id.back_to_WaterConnection);
        user = findViewById( R.id.user_icon_WaterConnection);
        notification = findViewById( R.id.notification_WaterConnection);
