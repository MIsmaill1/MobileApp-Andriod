...
public class Otp_verification extends AppCompatActivity {
    ...
    TextView verifybtn, number,email,resend_otp,resend_otp_time;
    String otpCode = "";
    Integer otp = 0;
    boolean check = false;
    LinearLayout backtosignup_form;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Resend otp timmer
         ...
         simpleVideoView = (VideoView) findViewById(R.id.bg_video4);
        ...
        backtosignup_form.setOnClickListener( new View.OnClickListener() {
            @Override
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent login = new Intent(Otp_verification.this ,Login.class);
        startActivity( login );
        finish();
    }
    ...
    private void ids()
    {
        verifybtn = findViewById(R.id.optp_verify_btn);
        ...
        number = findViewById( R.id.otp_phone_number );
        email = findViewById( R.id.otp_email );
        backtosignup_form = findViewById( R.id.back_tosignup_from );
    ...
    private void optpverify(){
      ...
      String Otp1 =  et_otpbox1.getText().toString();
        ...
        verifyOtpRequest.setEmail( email.getText().toString() );
        verifyOtpRequest.setMobileNumber( number.getText().toString() );
...
//
                        ...
                        builder1.setMessage(user.getMessage().toString());
    ...
    private void Resend_otp_api(){
        ...
        String token = PreferenceData.getPrefUserToken( getApplicationContext() );
        ProgressDialog progress = new ProgressDialog( Otp_verification.this );
        ...
        // validate register api intregration
            ...
            forgetPasswordRequest.setEmail(  getIntent().getStringExtra( "email" ) );
            forgetPasswordRequest.setMobileNumber( getIntent().getStringExtra( "number" ) );
